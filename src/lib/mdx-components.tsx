...
export function useMDXComponents(): MDXComponents {
  return {
    ...
    h1: (props) => (
      <AutoSizeText
        tag="h1"
        className="font-bold mb-[clamp(0.5rem,2vh,1.5rem)] text-blue-600"
        minFontSize={24}
        maxFontSize={56}
        {...props}
      />
    ...
    h2: (props) => (
      <AutoSizeText
        tag="h2"
        className="font-bold mb-[clamp(0.4rem,1.75vh,1.2rem)] text-blue-600/90"
        minFontSize={20}
        maxFontSize={40}
        {...props}
      />
    ...
    h3: (props) => (
      <AutoSizeText
        tag="h3"
        className="font-bold mb-[clamp(0.3rem,1.5vh,1rem)] text-blue-600/80"
        minFontSize={18}
        maxFontSize={32}
        {...props}
      />
    ),
    h4: (props) => <h4 className="text-[clamp(1.125rem,2.5vw,1.75rem)] font-bold mb-[clamp(0.25rem,1.25vh,0.75rem)] text-blue-600/70" {...props} />,
    h5: (props) => <h5 className="text-[clamp(0.875rem,2vw,1.25rem)] font-bold mb-[clamp(0.25rem,1vh,0.75rem)] text-blue-600/70" {...props} />,
    h6: (props) => <h6 className="text-[clamp(0.75rem,1.5vw,1rem)] font-bold mb-[clamp(0.25rem,1vh,0.75rem)] text-blue-600/60" {...props} />,
    ...
    // Special elements
    blockquote: (props) => (
      <blockquote className="border-l-4 border-blue-400 pl-[clamp(0.75rem,2vw,1.5rem)] py-[clamp(0.25rem,1vh,0.75rem)] my-[clamp(0.5rem,2vh,1.5rem)] bg-blue-50 rounded-sm" {...props} />
    ),
    ...
    code: (props) => {
      ...
      return isInline ? (
        <code
          className="font-mono bg-gray-100 text-[clamp(0.75rem,1.75vw,1rem)] px-1.5 py-0.5 rounded-md"
          {...rest}
        >
          {children}
        </code>
      ) : (
        <pre className="font-mono text-[clamp(0.75rem,1.75vw,1rem)] bg-gray-100 p-[clamp(0.5rem,2vh,1.5rem)] rounded-lg overflow-x-auto mb-[clamp(0.5rem,2vh,1.5rem)]">
    ...
    // Horizontal rule
    hr: () => <hr className="border-gray-300 my-[clamp(1rem,3vh,2rem)]" />,
  };
} 