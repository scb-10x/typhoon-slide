...
export default function MDXSlide({ content }: MDXSlideProps) {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-[clamp(0.5rem,2vw,2rem)]">
      <div className="slide-content max-h-full max-w-full overflow-auto p-[clamp(0.5rem,2vw,2rem)] prose-headings:leading-[1.2] prose-p:leading-[1.5]">
        {content}
      </div>
    </div>
  );
